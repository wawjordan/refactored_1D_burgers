%% Grid Refinement, ETE w/ IC. testing - Exact solution startup
clc; clear; close all;
IN = struct();
IN.order   = 4;
IN.N_IC    = 10;
...
fname = [...
    ...
    '\new\',...
    '\post_processing\shock_exact_start_alg1_k4'];
save(fname, 'OUT', '-v7.3')


%% Grid Refinement, ETE w/ IC. testing - Regular startup
clc; clear; close all;
IN = struct();
IN.order   = 4;
IN.N_IC    = 10;
...
fname = [...
    'C:\Users\Will\Documents\MATLAB\VT_Research',...
    '\new\',...
    '\post_processing\shock_regular_start_alg1_k4'];
save(fname, 'OUT', '-v7.3')
...
fname = [...
    'C:\Users\Will\Documents\MATLAB\VT_Research',...
    '\new\',...
    '\post_processing\shock_exact_start_alg1_k6'];
save(fname, 'OUT', '-v7.3')
...
fname = [...
    'C:\Users\Will\Documents\MATLAB\VT_Research',...
    '\new\',...
    '\post_processing\shock_regular_start_alg1_k6'];
save(fname, 'OUT', '-v7.3')