function [Esoln,EsolnIC,soln,OUT,S,stencil] = ete_solver_w_IC_v4(grid,Esoln,EsolnIC,soln,S)
%{
S   - input structure
...
for i = 2:S.stencil_size
    ...
    OUT = output_ete_iter_stuff(OUT,S,resnorm,UE,i,2);
end
end
...
stencil.U(:,i,2) = U - e_new; % update stencil with corrected solution
OUT = output_ete_iter_stuff(OUT,S,resnorm,UE,count,2);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
