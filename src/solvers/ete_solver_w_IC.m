function [Esoln,EsolnIC,soln,OUT,S,stencil] = ete_solver_w_IC(grid,Esoln,EsolnIC,soln,S)
%{
S   - input structure
...
%         L_BC1 = S.L_BC1;
%         L_BC2 = S.L_BC2;
%         R_BC1 = @(u,i) S.R_BC1(u,i,0); % dirichlet BC
%         R_BC2 = @(u,i) S.R_BC2(u,i,0); % dirichlet BC
%         RU = ss_residual(U,grid.dx,S.nu,grid.N);
...
%         
%         e_old = Esoln.U;
% %         S.ETEintegratorIC.um1 = e_old;
% %         S.ETEintegratorIC.um2 = e_old;
%         [e_new,resnorm,S,S.ETEintegrator] = S.ETEintegratorIC.step(...
%             e_old, S, RHS, LHS, L_BC1, L_BC2, R_BC1, R_BC2 );
%         Esoln.U = e_new;
%         UE = U - e_new; % corrected solution
%         stencil.U(:,i,j) = UE; % update stencil with corrected solution
% %         if (j<S.Niters)
