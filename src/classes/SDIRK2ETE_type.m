classdef SDIRK2ETE_type < time_integrator_type
    properties
        N
        u_alpha
    end
    methods
        function this = SDIRK2ETE_type( grid, ~, S )
...
%                                   this.newton_tol, this.max_newton_iter );                  
        ...
        function [u_alpha,R,S,this] = step1( this, u_old, S, RHS, LHS,...
                                             L_BC1, L_BC2, R_BC1, R_BC2 )
            F  = @(u) this.SDIRK2_res1( u, u_old,...
                                     this.dt, this.N, RHS, R_BC1, R_BC2 );
            dF = @(u) this.SDIRK2_jac1( u,...
                                     this.dt, this.N, LHS, L_BC1, L_BC2 );
            gamma = 0.5;
            [u_alpha,R] = newton_with_backtracking( u_old, F, dF, gamma,...
                                  this.newton_tol, this.max_newton_iter );
            this.u_alpha = u_alpha;
        end
        function [u_new,R,S,this] = step2( this, u_old, S, RHS, LHS,...
                                             L_BC1, L_BC2, R_BC1, R_BC2 )
            F  = @(u) this.SDIRK2_res2( u, u_old, this.u_alpha,...
                                     this.dt, this.N, RHS, R_BC1, R_BC2 );
            dF = @(u) this.SDIRK2_jac2( u,...
                                     this.dt, this.N, LHS, L_BC1, L_BC2 );
            gamma = 0.5;
            [u_new,R] = newton_with_backtracking( this.u_alpha, F, dF, gamma,...
                                  this.newton_tol, this.max_newton_iter );               
        end
